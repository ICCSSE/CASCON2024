...
<ul>
  ...
  <li>All authors should use the <a href="https://www.ieee.org/conferences/publishing/templates.html">IEEE Formatting Instructions</a>, which can be obtained from the IEEE Proceedings Template pages. Latex users should use the "sigconf" option, as well as the "review" (to produce line numbers for easy reference by the reviewers).</li>
</ul>
